...
Dygraph.Interaction.defaultModel = {
    mousedown: function(c, b, a) {
        ...
        if (c.altKey || c.shiftKey || c.button == 2) {
    ...
    dblclick: function(c, b, a) {
        ...
        //YC add zoom out 2 
        Dygraph.Interaction.zoomOut2(c, b, a); 
        //b.resetZoom()
    }
};
...
Dygraph.Plugins.Annotations = (function() {
    ...
    a.prototype.didDrawChart = function(v) {
        ...
        for (var s = 0; s < r.length; s++) {
            ...
            t.addAndTrackEvent(j, "keydown", b("keyDownHandler", "annotationKeyDownHandler", l, this));
            h.appendChild(j);
